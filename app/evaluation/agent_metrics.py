...
STATE_TRANSITION_TOOLS = frozenset(
    {
        ...
        "generate_order_tool",
        "go_back_to_requirement_collection",
        "go_back_to_destination_recommendation",
        "go_back_to_transport_planning",
        "go_back_to_accommodation_planning",
        "go_back_to_food_planning",
        "go_back_to_itinerary_generation",
        "go_back_to_budget_summarization",
...
QUALIFIED_CLAIM_PATTERN = re.compile(
    ...
    r"未锁定|不锁|暂未|不可保证|不能保证|需复核|可能|预计|"
...
def _claim_supported(
    *,
    ...
    matched_tools = sorted(called_tools & support_tools)
    if matched_tools and category != "booking":
        return True, "supported_by_tool_call:" + ",".join(matched_tools)
    return False, "missing_verification_or_tool_evidence"
