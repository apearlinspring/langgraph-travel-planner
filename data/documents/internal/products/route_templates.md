...
- 住宿示例候选：至少给 1 家与商圈、档次匹配的公开可查酒店作为“选址和档次示例”；必须说明库存、房型、早餐、取消政策和价格待二次核验、不锁价。无法给出酒店名时，要明确写“暂无可核验酒店示例”，不能用泛泛“星级酒店”替代。
...
费用说明必须优先贴合用户已确认预算，并拆分为大交通、住宿、门票/体验、当地交通、餐饮和服务/机动费用。样板价只能作为参考，不能覆盖用户预算；如果样板价与用户预算不一致，要说明需要调整交通时段、住宿档位、体验项目或餐饮标准。用户可见标题统一用“费用说明”，不再使用“费用边界”。

| 模块 | 必填表达 |
|---|---|
| 总预算 | 复述用户预算、人均或总价、是否覆盖当前方案 |
| 大交通 | 往返方式、票价来源、待核验日期 |
| 住宿 | 晚数、房间数、商圈/档次、示例酒店候选 |
| 门票/体验 | 公开参考价、预约边界、采集日期 |
| 餐饮/当地交通 | 日均口径和机动缓冲 |
| 服务/机动 | 接送、预约协助、应急联络、人工确认边界 |
...
- 交通口径：模板里必须写明“推荐方式 + 待核验边界”，例如“西安到杭州优先高铁/航班二选一，按出发日期核验票价和余票；当地交通以地铁、网约车和必要接驳为主”。
- 住宿商圈/档次：必须给出具体商圈和档次，例如“湖滨/武林/西湖东线舒适型酒店，优先早餐、地铁便利和晚归打车便利；库存、房型和取消政策待核验”。
- 景点票价参考：每条省心方案至少列 2-3 个景点公开参考价，并写“采集日期 2026-05-19、来源链接、待核验、不锁价”；未覆盖目的地时从景区官方页或公开票务页搜索后再写。
- 餐饮/服务边界：必须拆成“餐饮方向、可协助事项、不承诺事项”，例如“可推荐杭帮菜/茶歇/夜市，不承诺餐厅座位、门票预约成功或支付下单”。
